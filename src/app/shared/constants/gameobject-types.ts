...
GO_DATA_FIELDS[5][5] = { name: 'questID', tooltip: 'Required active quest_template.entry to work' };
...
GO_DATA_FIELDS[6][11] = { name: 'stealthAffected', tooltip: 'Boolean flag' };
...
GO_DATA_FIELDS[8][4] = { name: 'questID', tooltip: 'Required active quest_template.entry to work)' };
...
GO_DATA_FIELDS[10][1] = { name: 'questID', tooltip: 'Required active quest_template.entry to work' };
